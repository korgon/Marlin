...
#define STRING_CONFIG_H_AUTHOR "(korgon, rebuild config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Modded Mendel"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 58.56
  #define DEFAULT_bedKi 8.31
  #define DEFAULT_bedKd 103.14
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 837.2 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3600, 1800, 100, 10000 }

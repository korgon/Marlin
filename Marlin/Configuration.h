...
#define STRING_CONFIG_H_AUTHOR "(korgon, cupcake config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Modded Cupcake"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 94.12, 2667.90, 483.95 }
